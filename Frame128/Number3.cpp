...
void CNumber3::Late_Update(void)
{


}

void CNumber3::Render(HDC hDC)
{
...
void CNumber3::Release(void)
{

}

TCHAR * CNumber3::One(int _iScore)
{
	if ((_iScore % 10) == 0)
		m_pFrameKey = L"0";
...
TCHAR * CNumber3::Two(int _iScore)
{
	if (0 == (_iScore % 100) / 10)
		m_pTwoKey = L"0";
...
TCHAR * CNumber3::Three(int _iScore)
{
